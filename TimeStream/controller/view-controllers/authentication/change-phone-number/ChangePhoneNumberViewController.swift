...
protocol ChangePhoneNumberFlowDelegate: BaseViewControllerFlowDelegate {
    func changePhoneHasValidated(vc: ChangePhoneNumberViewController, phoneNumber: String, validationToken: String)
}

class ChangePhoneNumberViewController: BaseViewController,  UIPickerViewDataSource, UIPickerViewDelegate {
    
    weak var flowDelegate: ChangePhoneNumberFlowDelegate?
    ...
    @IBAction func proceed(_ sender: Any) {
        ...
        authService.validatePhoneNumber(number: number) { (success, id, error) in
            ...
            self.flowDelegate?.changePhoneHasValidated(vc: self, phoneNumber: number, validationToken: id)
        }
    }

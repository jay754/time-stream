...
class ExploreSearchVideosContentDatasourceDelegate: NSObject {
    ...
    private func loadItems(term: String) {
        ...
        service.searchContent(term: term, page: currentPage) { result in
            self.collectionView.endCurrentRefresh()
    ...
    private func loadNewestItems() {
        collectionView.beginRefresh()
        service.newestVideos(page: currentPage) { result in
            self.collectionView.endCurrentRefresh()
...
extension ExploreSearchVideosContentDatasourceDelegate: UICollectionViewDataSource {
...
extension ExploreSearchVideosContentDatasourceDelegate: UICollectionViewDelegate {
...
extension ExploreSearchVideosContentDatasourceDelegate: UICollectionViewDelegateFlowLayout {
